...
int main()
{
	...
	do {
		cout << ".............BAI TAP 12, CHUONG 01 - BAI TAP THEM \n"
			"1.khoi tao danh sach lien ket doi \n" <<
			"2.them phan tu vao dau DSLK doi \n" <<
			"3.them phan tu vao cuoi DSLK doi \n" <<
			"4.xoa phan tu dau DSLK doi \n" <<
			"5.xoa phan tu cuoi DSLK doi \n" <<
			"6.tim phan tu voi gia tri x va xoa no \n" <<
			"7.them phan tu dung truoc gia tri x \n" <<
			"8. Thoat\n";
		cout << "Chon: ";
		cin >> choice;
		switch (choice)
